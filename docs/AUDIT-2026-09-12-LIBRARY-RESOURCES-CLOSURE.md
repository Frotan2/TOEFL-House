...
| F1 | P2 | `tests/Canonical/Resources` did not exist: zero canonical coverage of the domain authority. | **FIXED** (`4033d08`) | 27 canonical tests / 107 assertions across books, custody+staged disposal, work orders; mutation-checked per §5 of `TEST_SUITE_ARCHITECTURE.md` (3 mutations, 3 kills, rows added to the doc table). |
