...
| `decisions/2026-09-09-first-run-genesis-structure.md` | ADR: First-run genesis structure lives in the guarded bootstrap; all later structure change keeps the four-actor SoD chain | **CURRENT** | `decisions/2026-09-09-first-run-genesis-structure.md`; `AUDIT-2026-09-09-FINAL-CERTIFICATION.md` §6 FC-1 |
