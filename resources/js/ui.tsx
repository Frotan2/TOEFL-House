...
export function Icon({ name, width = 17, height = 17, ...props }: IconProps) {
  ...
  const paths: Record<IconProps['name'], ReactNode> = {
    ...
    settings: <><circle cx="12" cy="12" r="3"/><path d="M19.4 15a1.8 1.8 0 0 0 .04 2l.04.04-1.7 1.7-.04-.04a1.8 1.8 0 0 0-2-.04l-.3.17a1.8 1.8 0 0 0-1 1.63V21h-2.4v-.58a1.8 1.8 0 0 0-1-1.63l-.3-.17a1.8 1.8 0 0 0-2 .04l-.04.04-1.7-1.7.04-.04a1.8 1.8 0 0 0 .04-2l-.17-.3a1.8 1.8 0 0 0-1.63-1H3.7v-2.4h.58a1.8 1.8 0 0 0 1.63-1l.17-.3a1.8 1.8 0 0 0-.04-2L6 7.96l1.7-1.7.04.04a1.8 1.8 0 0 0 2 .04l.3-.17a1.8 1.8 0 0 0 1-1.63V4h2.4v.58a1.8 1.8 0 0 0 1 1.63l.3.17a1.8 1.8 0 0 0 1-1.63l.3-.17a1.8 1.8 0 0 0 2 .04l.04-.04 1.7 1.7-.04.04a1.8 1.8 0 0 0-.04 2l.17.3a1.8 1.8 0 0 0 1.63 1H21v2.4h-.58a1.8 1.8 0 0 0-1.63 1l-.17.3Z"/></>,
...
const navigation = [
  { href: '/workspace', label: 'Home', key: 'workspace', icon: 'home' as const, group: 'Work' },
  ...
  { href: '/placement', label: 'Placement', key: 'placement', icon: 'academic' as const, group: 'Work' },
  { href: '/teachers', label: 'People & Faculty', key: 'teachers', icon: 'teacher' as const, group: 'Work' },
  { href: '/hr', label: 'HR', key: 'hr', icon: 'users' as const, group: 'People' },
  { href: '/crm', label: 'CRM & Follow-up', key: 'crm', icon: 'crm' as const, group: 'People' },
  { href: '/finance', label: 'Finance & Funding', key: 'finance', icon: 'finance' as const, group: 'Operations' },
  { href: '/payroll', label: 'Payroll', key: 'payroll', icon: 'finance' as const, group: 'Operations' },
  { href: '/library', label: 'Library & Resources', key: 'library', icon: 'settings' as const, group: 'Operations' },
  { href: '/communication', label: 'Communication', key: 'communication', icon: 'crm' as const, group: 'Operations' },
  { href: '/reporting', label: 'Reports & Dashboards', key: 'reporting', icon: 'reporting' as const, group: 'Operations' },
  { href: '/documents', label: 'Documents & Evidence', key: 'documents', icon: 'settings' as const, group: 'Operations' },
  { href: '/organization', label: 'Organization', key: 'organization', icon: 'management' as const, group: 'Governance' },
  { href: '/identity', label: 'Identity', key: 'identity', icon: 'users' as const, group: 'Governance' },
  { href: '/access', label: 'Access Governance', key: 'access', icon: 'settings' as const, group: 'Governance' },
  { href: '/privacy', label: 'Privacy & Consent', key: 'privacy', icon: 'settings' as const, group: 'Governance' },
  { href: '/audit', label: 'Audit & History', key: 'audit', icon: 'reporting' as const, group: 'Governance' },
  { href: '/management', label: 'Command Center', key: 'management', icon: 'management' as const, group: 'Control' },
];
