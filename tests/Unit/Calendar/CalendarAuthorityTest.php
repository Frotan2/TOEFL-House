...
final class CalendarAuthorityTest extends TestCase
{
    ...
    public function test_month_lengths_1404_common_and_invalid_day(): void
    {
        ...
        $this->assertRejection('calendar.invalid_day', function (): void {
            $this->authority->reverse(new SolarHijriDate(1404, 12, 30));
        });
    }
    ...
    public function test_day_exceeding_real_month_length_rejected(): void
    {
        ...
        $this->assertRejection('calendar.invalid_day', function (): void {
            $this->authority->validateSolarHijri(new SolarHijriDate(1404, 12, 30));
        });
        ...
        $this->assertRejection('calendar.invalid_day', function (): void {
            $this->authority->validateSolarHijri(new SolarHijriDate(1404, 7, 31));
        });
    }
